...
/**
 * The calculator program of graphical interface can only calculate addition,
 * subtraction, multiplication and division, There can be parentheses in the
 * formula. Numbers can be decimals
 */
